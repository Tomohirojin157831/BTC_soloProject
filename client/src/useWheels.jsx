...
export const useWheels = (width, height, front, radius) => {
  ...
  //車の前輪と後輪に関する情報(...は単一情報をコピーして持ってくる)
  const wheelInfos = [
    {
      ...wheelInfo,
  ...
  const propsFunc = () => ({
    ...
    type: "kinematic", //kinematicオブジェクトは力や重力による影響を受けず、プログラムで直接位置や速度を制御できる物体
  });
  //useCompundBody:複数の形状（シェイプ）を組み合わせて1つの複合的な物体（Compound Body）を作成するために使用されます。
